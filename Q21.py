...
#do saque e depois informar quantas notas de cada valor serão fornecidas. As notas
...
def sacarDinheiro():
    ...
    #Obter o valor do saque.
    saque = float(input("Por favor, informe o valor do saque:R$"))
